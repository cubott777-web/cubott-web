      ...
      <Container>
        ...
        <div className="grid gap-6 lg:grid-cols-12 lg:gap-8">
          <Reveal className="lg:col-span-7">
            ...
            <h2 id="products-title" className="display-lg mt-3 max-w-[14ch] text-navy">
              What we&apos;ve built.
            </h2>
          </Reveal>
          <Reveal delay={0.1} className="lg:col-span-4 lg:col-start-9 lg:self-end lg:pb-2">
            ...
            <Reveal as="li" key={p.key} delay={0.05 * i}>
              <div className="grid items-center gap-6 lg:grid-cols-12 lg:gap-12">
                ...
                <div className={cn("lg:col-span-7", i % 2 === 1 && "lg:order-1")}>
                  <div className="relative aspect-video overflow-hidden rounded-2xl bg-navy-900 shadow-frame">
