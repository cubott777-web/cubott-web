...
const problems = [
  ...
  },
  {
    ...
    description: "No real-time view of parts availability leads to stockouts, over-ordering, and idle machines.",
  },
  {
    icon: AlertTriangle,
    title: "Delayed Warranty Approvals",
    description: "Warranty claims sit in email chains for weeks, eroding trust with manufacturers and customers alike.",
  },
  {
    icon: UserX,
...
const solutions = [
  ...
  { stat: "60%", label: "Faster Approvals" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <AnimatedSection>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Dealerships are drowning
              <br />
              <span className="gradient-text-teal">in manual processes</span>
            </h2>
            <p className="text-white/50 text-lg mb-10 leading-relaxed">
              Agricultural machinery dealerships manage complex, multi-step workflows across service, parts, warranty, and finance — all without the right tools.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {problems.map((p, i) => (
                <motion.div
                  ...
                  className="glass-card p-5 rounded-xl group hover:border-white/10 transition-all"
                >
          ...
          <AnimatedSection delay={0.2}>
            ...
            <p className="text-white/50 text-lg mb-10 leading-relaxed">
              One unified platform replaces disconnected tools. Supervisors, store teams, finance, and manufacturers all work from the same system — with role-based access and complete traceability.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-10">
              {solutions.map((s, i) => (
                <motion.div
                  ...
                  className="glass-card p-6 rounded-2xl text-center hover:border-cubott-teal/20 transition-all group"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-white/40 text-xs leading-relaxed">
                    Fully isolated per dealership. Each tenant gets their own data, users, and configuration — with manufacturer-level visibility built in.
                  </div>
                </div>
              </div>
            </div>
