...
const field =
  "w-full rounded-lg border border-navy/20 bg-white px-4 py-3 text-[15px] text-navy placeholder:text-navy/35 transition-colors focus:border-blue focus:outline-none focus:ring-2 focus:ring-blue/25"
...
export default function ContactForm() {
  ...
  if (status === "sent") {
    return (
      <div role="status" className="rounded-2xl border border-navy/10 bg-surface p-8">
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="grid gap-5" aria-describedby="contact-help">
