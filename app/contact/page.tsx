          ...
          <div className="grid gap-14 lg:grid-cols-12 lg:gap-20">
            <div className="lg:col-span-5">
              <Reveal>
                ...
                <div className="mt-10 flex flex-col gap-6 border-t border-navy/10 pt-6 sm:flex-row sm:gap-10">
                  <div>
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-2 inline-block text-lg font-medium text-navy hover:text-blue"
                    >
